...
<body>
    ...
    <table>
    	...
    	<tr>
    		...
    		<td>http://localhost:8080/revolute/webapi/accounts</td>
    		<td>GET</td>
    	</tr>
    	<tr>
    		<td>Find particular account</td>
    		<td>http://localhost:8080/revolute/webapi/accounts/{accountID}</td>
    		<td>GET</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		...
    		<td>http://localhost:8080/revolute/webapi/transfers</td>
    		<td>GET</td>
    	</tr>
    	<tr>
    		<td>Account transfer history</td>
    		<td>http://localhost:8080/revolute/webapi/transfers/{accountID}</td>
    		<td>GET</td>
    	</tr>
    	<tr>
    		<td>Make a new transfer</td>
    		<td>http://localhost:8080/revolute/webapi/transfers/make</td>
    		<td>POST</td>
    	</tr>
    	</thead>
    </table>
